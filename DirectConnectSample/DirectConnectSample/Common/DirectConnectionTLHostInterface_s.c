...
extern const MIDL_SERVER_INFO DirectConnectionTLHostInterface_ServerInfo;

extern const RPC_DISPATCH_TABLE DirectConnectionTLHostInterface_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE DirectConnectionTLHostInterface___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0xF6A7AAF5,0xE634,0x44A4,{0xBA,0xF5,0x8D,0x8F,0x7A,0xF2,0xFB,0x40}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&DirectConnectionTLHostInterface_v1_0_DispatchTable,
    0,
    0,
    0,
    &DirectConnectionTLHostInterface_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE DirectConnectionTLHostInterface_v1_0_s_ifspec = (RPC_IF_HANDLE)& DirectConnectionTLHostInterface___RpcServerInterface;
...
static const MIDL_STUB_DESC DirectConnectionTLHostInterface_StubDesc = 
    {
    (void *)& DirectConnectionTLHostInterface___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION DirectConnectionTLHostInterface_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE DirectConnectionTLHostInterface_v1_0_DispatchTable = 
    {
    2,
    (RPC_DISPATCH_FUNCTION*)DirectConnectionTLHostInterface_table
    };

static const SERVER_ROUTINE DirectConnectionTLHostInterface_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)DirectConnectionClientConnected,
    (SERVER_ROUTINE)DirectConnectionGetHostFrame
    };

static const MIDL_SERVER_INFO DirectConnectionTLHostInterface_ServerInfo = 
    {
    &DirectConnectionTLHostInterface_StubDesc,
    DirectConnectionTLHostInterface_ServerRoutineTable,
    DirectConnectionTLHostInterface__MIDL_ProcFormatString.Format,
    DirectConnectionTLHostInterface_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
